\begin{table*}[htbp]
\centering
\caption{Multimodal Depression Detection: Experiment Results}
\label{tab:experiments}
\begin{tabular}{lccccrrrrr}
\hline
\textbf{Experiment} & \textbf{Sp} & \textbf{Tx} & \textbf{EEG} & \textbf{Fa} & \textbf{Acc.} & \textbf{F1} & \textbf{AUC} & \textbf{MAE} & \textbf{RMSE} \\
\hline
...
\begin{tablenotes}
\small
\item Sp=Speech, Tx=Text, Fa=Facial. All values on DAIC-WOZ test set.
\end{tablenotes}
\end{table*}
